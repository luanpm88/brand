    ...
    <table class="table table-striped mt-3">
        ...
        <tbody>
          <tr>
            ...
            <td class="text-end"><span class="display-5 fs-5 fw-bold">800,000</span> / năm</td>
          </tr>
        </tbody>
      </table>

    <div class="mt-4 mb-3 text-center">
        <button type="button" class="btn btn-warning btn-lg px-4">Đăng ký & Bước tiếp theo</button>
    </div>
@endsection
