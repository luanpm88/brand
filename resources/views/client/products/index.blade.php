...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Liên kết sàn TMĐT</h1>
    ...
    <div class="mb-4">
        ...
        @if (!$lazadaConnection->connected())
            <a href="{{ $lazadaConnectLink }}" class="btn btn-light me-2 connection-button">
                <img height="35px" src="{{ url('/image/lazada.png') }}" />
            </a>
        @else
    ...
    <div class="page-title-box">
        <div class="row align-items-center">    
            <div class="col-sm-6">
                <h2 class="page-title">QUẢN TRỊ SẢN PHẨM</h2>
                <ol class="breadcrumb">
            ...
            <div class="col-sm-6">
                <div class="text-end"> 
                    ...
                    <a href="" class="btn btn-light me-1 ms-2 px-2 py-1">
                        <img height="25px" src="{{ url('/image/lazada.png') }}" />
                    </a>
                </div>
            </div>
        </div>
