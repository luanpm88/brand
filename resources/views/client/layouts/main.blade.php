...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <input class="form-control form-control-dark w-100" type="text" placeholder="Gõ từ khóa tìm kiếm" aria-label="Search">
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
      <a class="nav-link d-flex align-items-center" href="#">
			<img class="me-2" style="border-radius: 100%;
			width: 35px;
			border: solid 1px rgba(255,255,255,0.6);" src="https://i.pravatar.cc/300" />
