...
@section('content')
    ...
    <ul class="nav nav-pills nav-fill wizard my-4 shadow-sm">
        ...
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#">
                ...
                <p class="mb-0">Chọn gói website</p>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#">
    ...
    <div class="my-3 text-center">
        <img width="200px" src="{{ url('image/devider2.png') }}" />
    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="domain" type="text" class="form-control" placeholder="Nhập tên miền mới" aria-label="Tên miền" aria-describedby="basic-addon1">
          ...
          <div class="card shadow">
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Nhập tên miền" aria-label="Tên miền" aria-describedby="basic-addon1">
                    <div id="validationServer03Feedback" class="invalid-feedback domain-feedback">
                        Please provide a valid city.
                    </div>
                </div>
                <a href="#" class="btn btn-secondary">Lưu thông tin</a>
            </div>
          </div>
        </div>
    </div>
